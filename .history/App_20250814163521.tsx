...
// Componente que decide a “tela” com base no estado `page`
...
// Área logada x fluxo de autenticação
...
const App: React.FC = () => {
  // Estado central de navegação (inclui 'reset-password')
  const [page, setPage] = useState<Page>('landing');
  const navigate = (target: Page) => setPage(target);

  return (
    <ApiKeyProvider>
      {/* Passa o navigate para o AuthProvider: necessário para o evento PASSWORD_RECOVERY */}
