  ...
  return (
    <AuthLayout title="Crie sua Conta" subtitle="Comece a prospectar em minutos.">
      <form onSubmit={handleSubmit} className="space-y-4 mt-4">
        <AuthInputField id="fullName" label="Nome Completo" type="text" value={fullName} onChange={e => setFullName(e.target.value)} placeholder="Seu nome completo" icon={<UserIcon className="h-5 w-5" />} disabled={loading} />
        ...
        <AuthInputField id="whatsapp" label="WhatsApp" type="tel" value={whatsapp} onChange={e => setWhatsapp(e.target.value)} placeholder="(XX) XXXXX-XXXX" icon={<WhatsAppIcon className="h-5 w-5" />} disabled={loading} />
