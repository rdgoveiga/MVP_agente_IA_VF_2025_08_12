...
export const SignUpPage: React.FC<SignUpPageProps> = ({ onNavigate }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // >>> Passa full_name (padrão reconhecido pelo Supabase para "Display name")
      ...
      <AuthLayout title="Sucesso!" subtitle="Sua conta foi criada.">
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-6">
            Cadastro realizado com sucesso. Enviamos um e-mail de confirmação. Agora você já pode fazer login.
          </p>
          <button
